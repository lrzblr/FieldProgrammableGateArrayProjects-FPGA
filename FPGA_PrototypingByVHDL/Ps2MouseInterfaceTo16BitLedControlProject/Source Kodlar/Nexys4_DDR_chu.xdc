...
#set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS33} [get_ports {dip_switches_16bits_tri_i[8]}]
#set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports {dip_switches_16bits_tri_i[9]}]
...
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {key0}]
...
# tri-color LEDs
##======================================================================================================================
#set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports { led_16bits_tri_o [0]}]
#set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports { led_16bits_tri_o [1]}]
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports { led_16bits_tri_o [2]}]
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports { led_16bits_tri_o [0]}]
#set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports { led_16bits_tri_o [1]}]
#set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports { led_16bits_tri_o [2]}]
