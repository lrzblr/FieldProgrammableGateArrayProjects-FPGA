...
HD_PWD='C:/Users/lrzbl/Desktop/fpga2.odev/TAB/TAB.runs/TAB_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TAB_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TAB_rst_clk_wiz_1_100M_0.tcl
