...
HD_PWD='C:/Users/lrzbl/Desktop/fpga2.odev/TAB/TAB.runs/TAB_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TAB_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TAB_dlmb_bram_if_cntlr_0.tcl
