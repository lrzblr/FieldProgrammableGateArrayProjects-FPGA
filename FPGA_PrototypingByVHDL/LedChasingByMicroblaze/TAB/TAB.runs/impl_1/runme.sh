...
HD_PWD='C:/Users/lrzbl/Desktop/fpga2.odev/TAB/TAB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TAB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TAB_wrapper.tcl -notrace
