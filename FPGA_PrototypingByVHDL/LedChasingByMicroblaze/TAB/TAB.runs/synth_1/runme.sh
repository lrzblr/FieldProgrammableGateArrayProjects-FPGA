...
HD_PWD='C:/Users/lrzbl/Desktop/fpga2.odev/TAB/TAB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TAB_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TAB_wrapper.tcl
