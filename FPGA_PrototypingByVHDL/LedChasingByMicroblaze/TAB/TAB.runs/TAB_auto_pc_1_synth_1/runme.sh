...
HD_PWD='C:/Users/lrzbl/Desktop/fpga2.odev/TAB/TAB.runs/TAB_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TAB_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TAB_auto_pc_1.tcl
